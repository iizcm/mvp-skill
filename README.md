...
| --- | --- |
| **Name** | `mvp-skill` |
| **Description** | AI agent skill: mvp |
| **Category** | general |
| **Version** | `0.1.0` |
| **Author** | Community |
| **License** | MIT |
...
cp -r mvp ~/.hermes/skills/mvp/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/mvp-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/mvp-skill.git ~/.hermes/skills/mvp/
```
...
```text
Use the mvp skill to <describe your specific task here>
```
...
```text
Gunakan skill mvp untuk <deskripsikan tugas spesifik Anda di sini>
```
